...
public class JulFragment extends Fragment implements climateAdapter.OnClickListener{

    private static final String TAG="JulFragment";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter=new climateAdapter(climateData, JulFragment.this);
