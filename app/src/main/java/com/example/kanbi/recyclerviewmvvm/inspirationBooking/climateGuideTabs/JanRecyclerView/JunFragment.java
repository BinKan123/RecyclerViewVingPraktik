...
public class JunFragment extends Fragment implements climateAdapter.OnClickListener{

    private static final String TAG="JunFragment";
    ...
    public View onCreateView(LayoutInflater inflater,  @Nullable ViewGroup container, @Nullable
        ...
        View view=inflater.inflate(R.layout.fragment_jun, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter=new climateAdapter(climateData, JunFragment.this);
