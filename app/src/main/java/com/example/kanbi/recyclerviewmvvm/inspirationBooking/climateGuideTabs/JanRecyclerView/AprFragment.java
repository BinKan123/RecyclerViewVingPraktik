...
public class AprFragment extends Fragment implements climateAdapter.OnClickListener{

    private static final String TAG="AprFragment";
    ...
    public View onCreateView(LayoutInflater inflater,  @Nullable ViewGroup container, @Nullable
        ...
        View view=inflater.inflate(R.layout.fragment_apr, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter=new climateAdapter(climateData, AprFragment.this);
