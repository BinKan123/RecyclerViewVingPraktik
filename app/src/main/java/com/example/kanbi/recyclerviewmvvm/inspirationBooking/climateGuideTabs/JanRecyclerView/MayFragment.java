...
public class MayFragment extends Fragment implements climateAdapter.OnClickListener{

    private static final String TAG="MayFragment";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter=new climateAdapter(climateData, MayFragment.this);
